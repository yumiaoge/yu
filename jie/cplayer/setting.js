var YZM = {
	...
	'video': {
		...
		'con_play': function() {
			...
			var cplayer =
				`<div class="memory-play-wrap"><div class="memory-play"><span class="close">×</span><span>上次看到 </span><span>${YZM.ctime}</span><span class="play-jump">记忆播放</span><span class="play-jumpNO">重新播放</span></div></div>`
